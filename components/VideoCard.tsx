...
const VideoCard = ({
    ...
    return (
        <Link href={`/video/${id}`} className="video-card">
            <Image src={thumbnail} alt="thumbnail" width={320} height={160} className={thumbnail} style={{margin: '0 auto', borderRadius: '10px'}} layout="responsive" objectFit="cover" objectPosition="center" priority={true}/>
            <article>
                <div>
                    <figure>
